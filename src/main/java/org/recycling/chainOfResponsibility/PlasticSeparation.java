...
public class PlasticSeparation extends SeparationProcess {

    public PlasticSeparation(SeparationProcess separationProcess){
        setSuccessor(separationProcess);
    }
    @Override
    public void separate(IRecyclable recyclable) {
        if(canSeparateRecyclable(recyclable)){
            System.out.println("separating plastic......");
    ...
    public boolean canSeparateRecyclable(IRecyclable recyclable){
        return recyclable.getType()== RecyclableType.S;
    }
}
